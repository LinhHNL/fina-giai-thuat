...
public class ShuffleOperation : ILLHFunctionInterface
{ private int counter;
    ...
    {
        return ShuffleOperationFunction(orgTour);
    }

    private List<int> ShuffleOperationFunction(List<int> orgTour)
    {   
         // ShuffleOperation: Xóa trọn
    // Thực hiện xáo trộn các thành phố với nhau
