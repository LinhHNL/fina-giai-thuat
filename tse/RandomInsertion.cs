...
public class RandomInsertion : ILLHFunctionInterface
{ private int counter;
    ...
    {
        return RandomInsertionFunction(orgTour);
    }

    private List<int> RandomInsertionFunction(List<int> orgTour)
    {   
        // Random Insertion (RI): Chèn ngẫu nhiên
        // Chọn ngẫu nhiên hai thành phố i và j.
        // Chèn thành phố i vào vị trí j của tour.
